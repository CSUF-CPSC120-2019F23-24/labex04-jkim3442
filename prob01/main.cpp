...
int main()
{
  ...
  //It's no longer alphabetic because we increase the value to change it from a letter to a symbol.
  ...
  //It became a negative value afterwords because we overflowed  my_short2 for its data type while for my_int2 we didnt overflow its data type.
  ...
  //It became a negative value afterwords because we overflowed  my_short3 for its data type while for my_int3 we didnt overflow its data type.
